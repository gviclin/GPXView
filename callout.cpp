...
void Callout::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    QPointF anchor = mapFromParent(m_chart->mapToPosition(m_anchor,m_currentserie));
...
void Callout::updateGeometry(QLineSeries* serie)
{
    m_currentserie=serie;
    setPos(m_chart->mapToPosition(m_anchor, m_currentserie) + QPoint(10, -50));
    prepareGeometryChange();
