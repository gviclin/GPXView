...
void CGeoConvert::DatumConvert(int dIn, double LatIn, double LongIn, double HtIn, int dTo,  double& LatTo, double& LongTo, double& HtTo){
...
void CGeoConvert::LLtoUTM(int eId, double Lat, double Long,  double& Northing, double& Easting, int& Zone){
...
void CGeoConvert::UTMtoLL(int eId, double Northing, double Easting, int Zone,  double& Lat, double& Long){
